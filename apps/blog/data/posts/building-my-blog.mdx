...
Initially I really wanted to use [Shiki Twoslash](https://shikijs.github.io/twoslash/) for it's **amazing** TypeScript snippets. Unfortunately I could [not  get this up and running](https://github.com/shikijs/twoslash/issues/148) [Astro](https://astro.build/). So I ended up running with [Next.js](https://nextjs.org/) which has ended up bening an absolute please to work with.
