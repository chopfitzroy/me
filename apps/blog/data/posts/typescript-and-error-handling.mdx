...
Could the above pattern be considered back practice? Probably it is certainly less robust that wrapping everything in `try` but part of me considers that a good thing. Doing the above I am being more precise about what I am expecting and creating a faster feedback loop for when something I am not expecting occurs.
